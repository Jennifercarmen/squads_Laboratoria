          ...
          for (let i = 0; i < squead.length; i++) {
            for (let j = 0; j < student.length; j++) {
              if (squead[i] === student[j].index) {
                var index = student[j].index;
                var names = student[j].name.first;
                var perfil = student[j].perfil;
                ...
                <a class="waves-effect waves-light" href="#modal${index}"><img src="../assets/img/user.png" alt="" class="circle image-student" height="50px" width="50px">
                </a>
               ${start}
              <p class="name-student">${last}  ${name} </p>
              <p class="name-student">${perfil} </p>
